...
class AgendaWidgetLoggerTest {
    ...
    @Mock private lateinit var mockFirebaseAnalytics: FirebaseAnalytics

    @Mock private lateinit var mockAmplitude: Amplitude

    @Mock private lateinit var mockPrefs: AgendaWidgetPrefs
    ...
    fun setUp() {
        ...
        agendaWidgetLogger =
            AgendaWidgetLogger(mockAmplitude, mockFirebaseAnalytics, mockPrefs, context)
    }
    ...
    fun testLogActivityStartedEvent() {
        ...
        verify(mockFirebaseAnalytics)
            .logEvent(eq(AgendaWidgetLogger.Event.ACTIVITY_STARTED.eventName), any())
    }
    ...
    fun testLogNavigationEvent() {
        ...
        verify(mockFirebaseAnalytics)
            .logEvent(eq(AgendaWidgetLogger.Event.NAVIGATION.eventName), any())
    }
    ...
    fun testLogPermissionsResultEvent() {
        ...
        verify(mockFirebaseAnalytics)
            .logEvent(eq(AgendaWidgetLogger.Event.PERMISSIONS_RESULT.eventName), any())
    }
    ...
    fun testLogOnboardingCompleteEvent() {
        ...
        verify(mockFirebaseAnalytics)
            .logEvent(eq(AgendaWidgetLogger.Event.ONBOARDING_COMPLETE.eventName), any())
    }
    ...
    fun testLogActionButtonEvent() {
        ...
        verify(mockFirebaseAnalytics)
            .logEvent(eq(AgendaWidgetLogger.Event.ACTION_BUTTON.eventName), any())
    }
    ...
    fun testLogUpdatePrefEvent() {
        ...
        verify(mockFirebaseAnalytics)
            .logEvent(eq(AgendaWidgetLogger.Event.UPDATE_PREF.eventName), any())
    }
    ...
    fun testLogSelectItemEvent() {
        ...
        verify(mockFirebaseAnalytics)
            .logEvent(eq(AgendaWidgetLogger.Event.SELECT_ITEM.eventName), any())
    }
    ...
    fun testLogWidgetLifecycleEvent() {
        ...
        verify(mockFirebaseAnalytics)
            .logEvent(eq(AgendaWidgetLogger.Event.WIDGET_LIFECYCLE_EVENT.eventName), any())
    }
